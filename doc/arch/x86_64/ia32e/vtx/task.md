...
```ia32eEmulatorX2apicReadTmrCallbackFn``` - Called with idx set to the tmr idx (0 - 7), expected to return a bitmap of vectors for which the interrupt was level triggered (essentially, emulate the TMR on the emulators behalf) <br>
